...
<div class="navbar-fixed">
    <nav class="indigo darken-4" style="background-color: #404040 !important;">
        <div class="container">
            <div class="nav-wrapper nav-flex-wrapper <?php echo e(Request::is('/') ? 'homepage-logo-right' : ''); ?>">
...
<a href="<?php echo e(route('home')); ?>" class="brand-logo right" style="display: flex; align-items: center; gap: 10px;">
    ...
    <ul class="sidenav" id="mobile-demo">
        ...
        <li class="<?php echo e(Request::is('agents*') ? 'active' : ''); ?>">
            <a href="<?php echo e(route('agents')); ?>">العملاء</a>
        </li>
        ...
        <?php if(auth()->guard()->guest()): ?>
            <li><a href="<?php echo e(route('login')); ?>"><i class="material-icons">input</i> تسجيل الدخول</a></li>
            <li><a href="<?php echo e(route('register')); ?>"><i class="material-icons">person_add</i> تسجيل</a></li>
        <?php else: ?>
            <li>
                <?php if(Auth::user()->role->id == 1): ?>
                    <a href="<?php echo e(route('admin.dashboard')); ?>">الملف الشخصي</a>
                <?php elseif(Auth::user()->role->id == 2): ?>
                    <a href="<?php echo e(route('agent.dashboard')); ?>">الملف الشخصي</a>
                <?php elseif(Auth::user()->role->id == 3): ?>
                    <a href="<?php echo e(route('user.dashboard')); ?>">الملف الشخصي</a>
                <?php endif; ?>
            </li>
            <li>
