                    ...
                    <form action="<?php echo e(route('admin.services.update',$service->id)); ?>" method="POST">
                        ...
                        <div class="form-group form-float">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <textarea name="description" rows="4" class="form-control no-resize"><?php echo e($service->description); ?></textarea>
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="text" name="icon" class="form-control" value="<?php echo e($service->icon); ?>">
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="number" name="service_order" class="form-control" min="1" value="<?php echo e($service->service_order); ?>">
