<?php $__env->startSection('content'); ?>
        ...
        <div class="container">
            ...
            <div class="row" style="display:flex;justify-content:center;">
                ...
                <div class="col s12 m4">
                    <div class="marketing-card" role="article" aria-label="توثيق العقود الالكترونية">
                        ...
                        <h3 class="title">توثيق العقود الالكترونية</h3>
                    </div>
                </div>
            ...
            <div class="row">
                <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col s12 m4 service-item">
    ...
    <section class="section grey lighten-3 center">
        <div class="container">
            ...
            <h4 class="section-heading"><?php echo e(__('messages.testimonials')); ?></h4>
                    ...
                    <div class="carousel-item testimonial-item" href="#<?php echo e($testimonial->id); ?>!">
                        <div class="card testimonial-card">
                            ...
                            <div class="card-image testimonial-image">
                                <img src="<?php echo e(Storage::url('testimonial/'.$testimonial->image)); ?>">
                            </div>
