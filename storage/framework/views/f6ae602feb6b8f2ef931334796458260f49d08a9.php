...
<?php $__env->startSection('content'); ?>
    ...
    <div class="block-header">
        <a href="<?php echo e(route('admin.tags.create')); ?>" class="waves-effect waves-light btn right m-b-15 addbtn">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="<?php echo e(route('admin.tags.edit',$tag->id)); ?>" class="btn btn-info btn-sm waves-effect">
                                            <i class="material-icons">edit</i>
                                        </a>
                                        <button type="button" class="btn btn-danger btn-sm waves-effect" onclick="deleteTag(<?php echo e($tag->id); ?>)">
                                            <i class="material-icons">delete</i>
                                        </button>
                                        <form action="<?php echo e(route('admin.tags.destroy',$tag->id)); ?>" method="POST" id="del-tag-<?php echo e($tag->id); ?>" style="display:none;">
                                            <?php echo csrf_field(); ?>
