...
<?php $__env->startSection('content'); ?>
    ...
    <div class="block-header">
        <a href="<?php echo e(route('admin.testimonials.create')); ?>" class="waves-effect waves-light btn right m-b-15 addbtn">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if(Storage::disk('public')->exists('testimonial/'.$testimonial->image)): ?>
                                            <img src="<?php echo e(Storage::url('testimonial/'.$testimonial->image)); ?>" alt="<?php echo e($testimonial->name); ?>" width="160" class="img-responsive img-rounded">
                                        <?php endif; ?>
                                    </td>
                                    <td><?php echo e($testimonial->name); ?></td>
                                    <td><?php echo e($testimonial->testimonial); ?></td>
                                    <td class="text-center">
                                        <a href="<?php echo e(route('admin.testimonials.edit',$testimonial->id)); ?>" class="btn btn-info btn-sm waves-effect">
                                            <i class="material-icons">edit</i>
                                        </a>
                                        <button type="button" class="btn btn-danger btn-sm waves-effect" onclick="deleteTestimonial(<?php echo e($testimonial->id); ?>)">
                                            <i class="material-icons">delete</i>
                                        </button>
                                        <form action="<?php echo e(route('admin.testimonials.destroy',$testimonial->id)); ?>" method="POST" id="del-testimonial-<?php echo e($testimonial->id); ?>" style="display:none;">
                                            <?php echo csrf_field(); ?>
