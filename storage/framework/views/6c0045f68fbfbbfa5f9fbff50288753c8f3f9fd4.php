                ...
                <div class="col s12 m8">
                    <div class="contact-content">
                        ...
                        <form id="contact-us" action="" method="POST">
                            ...
                            <?php if(auth()->guard()->check()): ?>
                                <div class="input-field col s12">
                                    <i class="material-icons prefix">البريدالالكتروني</i>
                ...
                <div class="col s12 m4">
                    <div class="contact-sidebar">
                        <div class="m-t-30">
                            ...
                            <h6 class="uppercase">9200 33 948</h6>
                        ...
                        <div class="m-t-30">
                            ...
                            <h6 class="uppercase">info@alqasim.com.sa</h6>
                        ...
                        <div class="m-t-30">
                            ...
                            <h6 class="uppercase">الرياض-حي السلي-طريق أبي عبيدة بن الجراح
