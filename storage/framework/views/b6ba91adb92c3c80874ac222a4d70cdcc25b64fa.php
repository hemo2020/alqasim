                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if($message->status == 0): ?>
                                                <a href="<?php echo e(route('user.message.read',$message->id)); ?>" class="btn btn-small orange waves-effect">
                                                    <i class="material-icons">local_library</i>
                                                </a>
                                            <?php else: ?> 
                                                <a href="<?php echo e(route('user.message.read',$message->id)); ?>" class="btn btn-small green waves-effect">
                                            ...
                                            <form action="<?php echo e(route('user.messages.destroy',$message->id)); ?>" method="POST" id="del-message-<?php echo e($message->id); ?>" style="display:none;">
                                                <?php echo csrf_field(); ?>
