...
<div class="navbar-fixed">
    <nav class="indigo darken-4" style="background-color: #404040 !important;">
        <div class="container">
            <div class="nav-wrapper nav-flex-wrapper {{ Request::is('/') ? 'homepage-logo-right' : '' }}">
...
<a href="{{ route('home') }}" class="brand-logo right" style="display: flex; align-items: center; gap: 10px;">
    ...
    <img src="{{ asset('images/logo.png') }}" alt="Company logo" class="custom-logo-img" style="height: 48px; width: auto; max-width: 100%; flex-shrink: 0;">
</a>
                <ul class="hide-on-med-and-down">
                    ...
                    <li class="{{ Request::is('contact') ? 'active' : '' }}">
                        <a href="{{ route('contact') }}" style="font-size: 1.3rem; font-weight: bold;">اتصل بنا</a>
                    </li>

                    <li class="{{ Request::is('blog*') ? 'active' : '' }}">
                        <a href="{{ route('blog') }}" style="font-size: 1.3rem; font-weight: bold;">المدونة</a>
                    </li>

                    <li class="{{ Request::is('agents*') ? 'active' : '' }}">
                        <a href="{{ route('agents') }}" style="font-size: 1.3rem; font-weight: bold;">العملاء</a>
                    </li>

                    <li class="{{ Request::is('gallery') ? 'active' : '' }}">
                        <a href="{{ route('gallery') }}" style="font-size: 1.3rem; font-weight: bold;">معرض الصور</a>
                    </li>

                    <li class="{{ Request::is('property*') ? 'active' : '' }}">
                        <a href="{{ route('property') }}" style="font-size: 1.3rem; font-weight: bold;">العقارات</a>
                    </li>

                    <li class="{{ Request::is('/') ? 'active' : '' }}">
                        <a href="{{ route('home') }}" style="font-size: 1.3rem; font-weight: bold;">الرئيسية</a>
                    </li>
                    @guest
    ...
    <ul class="sidenav" id="mobile-demo">
        ...
        <li class="{{ Request::is('gallery') ? 'active' : '' }}">
            <a href="{{ route('gallery') }}">معرض الصور</a>
        </li>

        <li class="{{ Request::is('agents*') ? 'active' : '' }}">
            <a href="{{ route('agents') }}">العملاء</a>
        </li>
        ...
        <li>
            <a href="https://api.whatsapp.com/send?phone=966920033948" target="_blank">
                <svg
                    viewBox="0 0 16 16"
                    class="bi bi-whatsapp"
                    fill="currentColor"
        ...
        @guest
            <li><a href="{{ route('login') }}"><i class="material-icons">input</i> تسجيل الدخول</a></li>
            <li><a href="{{ route('register') }}"><i class="material-icons">person_add</i> تسجيل</a></li>
        @else
            <li>
                @if(Auth::user()->role->id == 1)
                    <a href="{{ route('admin.dashboard') }}">الملف الشخصي</a>
                @elseif(Auth::user()->role->id == 2)
                    <a href="{{ route('agent.dashboard') }}">الملف الشخصي</a>
                @elseif(Auth::user()->role->id == 3)
