...
@section('content')
    ...
    <section class="section grey lighten-4 center">
        <div class="container">
            <div class="row">
                <h4 class="section-heading">{{ __('messages.services') }}</h4>
            </div>
    ...
    <section class="section">
        <div class="container">
            <div class="row">
                <h4 class="section-heading">{{ __('messages.featured_properties') }}</h4>
            </div>
            <div class="row">
                    ...
                    <div class="col s12 m6 l4">
                        <div class="card">
                            <div class="card-image">
                                ...
                                @else
                                    <span class="card-image-bg" style="background-image:url({{asset('frontend/images/default.jpg')}});"></span>
                                @endif
                            ...
                            <div class="card-content property-content">
                                ...
                                <div class="address">
                                    ...
                                    <span>{{ ucfirst($property->type) }} {{ __('messages.for') }} {{ $property->purpose }}</span>
                                </div>
                            ...
                            <div class="card-action property-action">
                                <span class="btn-flat">
                                    ...
                                    {{ __('messages.bedroom') }}: <strong>{{ $property->bedroom}}</strong> 
                                </span>
                                <span class="btn-flat">
                                    <i class="material-icons">check_box</i>
                                    {{ __('messages.bathroom') }}: <strong>{{ $property->bathroom}}</strong> 
                                </span>
                                <span class="btn-flat">
                                    <i class="material-icons">check_box</i>
                                    {{ __('messages.area') }}: <strong>{{ $property->area}}</strong> {{ __('messages.square_feet') }}
                                </span>
                                <span class="btn-flat">
                    ...
                    <div class="carousel-item testimonial-item" href="#{{$testimonial->id}}!">
                        <div class="card testimonial-card">
                            ...
                            <div class="card-image testimonial-image">
                                <img class="responsive-img" src="{{Storage::url('testimonial/'.$testimonial->image)}}">
                            </div>
    ...
    <section class="section center">
        <div class="row">
            <h4 class="section-heading">{{ __('messages.recent_blog') }}</h4>
        </div>
        <div class="container">
            <div class="row">
